...
export const Contact = () => {
  return (
    <div className='w-[100%] flex justify-center pb-10 bg-[#74C365]'>
        <div className='lg:w-[80%] w-[90%] flex rounded-2xl '>
            
            <div className='w-[100%] flex flex-col justify-between h-[100%] text-white'>
                <h1 className='bg-white  rounded-lg px-4 py-2 text-[#74C365] mb-20 text-center lg:mt-40 lg:text-6xl text-4xl shadow-2xl shadow-green'>Contacts</h1>
